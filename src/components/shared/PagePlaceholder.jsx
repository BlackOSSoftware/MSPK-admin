...
const PagePlaceholder = ({ title, module }) => {
    return (
        <div className="space-y-4">
            <h1 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-foreground to-muted-foreground/70">
                {title}
            </h1>
            <Card className="min-h-[400px] flex items-center justify-center border-dashed border-border/70 bg-secondary/30">
                <div className="text-center space-y-2">
                    ...
                    <h3 className="text-lg font-medium text-foreground">Development in Progress</h3>
