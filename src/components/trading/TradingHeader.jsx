...
const TradingHeader = ({ symbol, onSymbolChange, onToggleWatchlist, activeBot, symbolStrategies = [], onToggleStrategy, strategyFilter = 'ALL', onStrategyFilterChange, onTitleClick, timeframe, onTimeframeChange, chartType, onChartTypeChange, onIndicatorsClick, onSettingsClick, onResetChart, onSnapshotClick }) => {
