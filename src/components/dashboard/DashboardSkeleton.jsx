...
const DashboardSkeleton = () => {
    return (
        <div className="space-y-4 flex flex-col h-auto lg:h-full lg:overflow-hidden pb-3 sm:pb-4 lg:pb-0">
            {/* Top Stats Grid */}
            ...
            <div className="flex-1 lg:min-h-0 grid grid-cols-1 lg:grid-cols-12 gap-3 sm:gap-4 lg:pb-2">
                ...
                <div className="lg:col-span-9 flex flex-col gap-3 h-auto lg:h-full lg:min-h-0">
                    ...
                    <div className="dashboard-surface soft-shadow h-64 sm:h-72 lg:h-auto lg:flex-1 lg:min-h-0 bg-card/90 border border-border/70 rounded-2xl animate-pulse relative overflow-hidden">
                        <div className="h-11 sm:h-12 border-b border-border/70 bg-secondary/30 px-3 sm:px-4 flex items-center justify-between">
                    ...
                    <div className="hidden md:block dashboard-surface soft-shadow h-56 lg:h-56 shrink-0 bg-card/90 border border-border/70 rounded-2xl animate-pulse">
                ...
                <div className="lg:col-span-3 flex flex-col gap-3 h-auto lg:h-full lg:min-h-0">
                    ...
                    <div className="dashboard-surface soft-shadow h-64 sm:h-80 lg:h-auto lg:flex-1 lg:min-h-0 bg-card/90 border border-border/70 rounded-2xl animate-pulse">
                        <div className="h-10 border-b border-border/70 bg-secondary/30 px-3 sm:px-4 flex items-center justify-between">
                            <div className="w-24 h-3 bg-muted rounded"></div>
                        </div>
                    ...
                    <div className="dashboard-surface soft-shadow h-auto lg:h-48 shrink-0 bg-card/90 border border-border/70 rounded-2xl animate-pulse">
                        <div className="h-9 border-b border-border/70 bg-secondary/30 px-3 sm:px-4 flex items-center">
                            <div className="w-24 h-3 bg-muted rounded"></div>
                        </div>
                        <div className="p-2 grid grid-cols-3 gap-1.5 sm:gap-2">
                            {[1, 2, 3, 4, 5, 6].map(i => (
