...
const AllBlogs = () => {
    ...
    const loadBlogs = useCallback(async () => {
        ...
        try {
            ...
            const { results, totalPages: pages, totalResults: total } = response.data;
            setBlogs(results || []);
    ...
    return (
        <div className="p-4 space-y-4">
            ...
            <ConfirmDialog
                ...
                title="Delete Blog"
                message={`Are you sure you want to permanently delete "${deleteTarget?.title || 'this blog'}"? This action cannot be undone.`}
